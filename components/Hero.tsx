    ...
    <div className="@container">
      <div className="@[480px]:p-4 px-0 pb-4">
        <div
          ...
          style={{
            backgroundImage: `linear-gradient(to top, rgba(16, 34, 22, 0.9) 0%, rgba(16, 34, 22, 0.4) 50%, rgba(0, 0, 0, 0.1) 100%), url("${heroImageUrl}")`,
          }}
        >
          <div className="flex flex-col gap-3 text-center z-10 w-full animate-fade-in">
            ...
            <p className="text-gray-200 text-sm font-normal leading-relaxed max-w-[32ch] mx-auto">
              Membentuk Generasi Qur'ani yang Berakhlaqul Karimah, Cerdas, dan
              Mandiri.
            </p>
          </div>
          <a
