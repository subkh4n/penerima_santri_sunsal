...
const InfoSection: React.FC<InfoSectionProps> = ({ onViewAllClick }) => {
  const infoCards = [
    ...
    },
    {
      ...
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuDjy74odUUVdeiVEcUXqTEt3wftbITfQo3Z_WMRGcuRRN8j8yw1RVVZ_nz7hS0YHBLIVTXGldwKkcdOQzTCL3jcMiybYgANHZXKp4dJs3z175ONwzweTwfl49prXqgEoFaZO-Kb0sdN7yF1TDO6A0QX9jHqaDcfeisIkcu51d22YbZA3-WqonJbTPOp_VJmSTGxpYXoO_bvWuPnb7XUvOqFcmYJn-gNN3kcJCcgJI5WuFt2tkOD9775EMcgueknNAZfIFcTk9WIz_AW",
      icon: "info",
    },
    {
  ...
  return (
    <div className="pt-8 pb-4">
      <div className="px-4 pb-2 flex justify-between items-end">
        <h2 className="text-text-main dark:text-white tracking-tight text-[22px] font-bold leading-tight">
          Informasi Penting
        </h2>
        <button
      ...
      <div className="flex flex-col gap-4 p-4 pt-2">
        {infoCards.map((card, idx) =>
          card.fullWidth ? (
            <div
              key={idx}
              className="group flex flex-col rounded-xl bg-white dark:bg-[#1f3528] shadow-[0_2px_8px_rgba(0,0,0,0.04)] overflow-hidden border border-gray-100 dark:border-gray-800 transition-all hover:shadow-md"
            >
              <div
            ...
            <div
              key={idx}
              className="flex items-stretch justify-between gap-4 rounded-xl bg-white dark:bg-[#1f3528] p-4 shadow-[0_2px_8px_rgba(0,0,0,0.04)] border border-gray-100 dark:border-gray-800 transition-all hover:shadow-md"
            >
